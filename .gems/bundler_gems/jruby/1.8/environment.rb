...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-rack-1.0.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-jars-1.6.0/lib")
...
module Gem
  def self.ruby ; "/Users/nds/.rvm/rubies/jruby-1.5.6/bin/jruby" ; end
